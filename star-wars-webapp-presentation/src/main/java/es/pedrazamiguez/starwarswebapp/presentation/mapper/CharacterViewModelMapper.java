...
public interface CharacterViewModelMapper {
  ...
  @Mapping(target = "characters", source = "paginatedCharacters.items")
  ...
  CharacterViewModel toViewModel(Page<Character> paginatedCharacters, String query, int page, String sortBy,
