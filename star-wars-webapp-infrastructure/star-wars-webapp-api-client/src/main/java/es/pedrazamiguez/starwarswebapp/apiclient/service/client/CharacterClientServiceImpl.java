...
public class CharacterClientServiceImpl implements CharacterClientService {
  ...
  public List<Character> fetchAllCharacters() {
    ...
    do {
      ...
      if (!ObjectUtils.isEmpty(paginatedCharacters)
          && !ObjectUtils.isEmpty(paginatedCharacters.getCharacters())) {
        allCharacters.addAll(paginatedCharacters.getCharacters());
        page++;
      } else {
        break;
      }
  ...
  private PaginatedCharacters getPaginatedCharacters(final int page) {
